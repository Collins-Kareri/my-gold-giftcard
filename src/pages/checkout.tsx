...
function CheckOut() {
	...
	return (
        <div className="tw-flex tw-justify-center tw-items-center tw-flex-col tw-w-full tw-h-screen">
            <button className="tw-capitalize tw-fixed tw-top-8 tw-left-12 tw-font-bold" onClick={()=>navigate("/")}><FontAwesomeIcon icon={"caret-left"}/> back</button>
            ...
            <p className="tw-font-bold tw-uppercase tw-mt-2">we support bitcoin, ethereum and usdt</p>
		</div>
	);
}
